        ...
        <div className="container">
          <div className="flex justify-between items-center ">
            ...
            <div className="w-1/3 flex flex-col items-end gap-7">
              ...
              <h1 className="text-white text-end text-[60px] font-black max-w-[440px]">
              ...
              <button className="bg-yellowMain -mt-6 text-[#23212A] text-base font-bold w-[194px] h-[60px] outline-none border-none shadow-md">
                بزن بریم
              </button>
            </div>
          </div>
